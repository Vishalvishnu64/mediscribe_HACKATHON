...
import { Camera, MoonStar, Sun, Type, Save } from 'lucide-react';
    ...
    <Layout title="Settings" subtitle="Manage your profile, accessibility and appearance.">
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
        ...
        <div className="bg-white border border-slate-200 rounded-3xl p-6 shadow-sm xl:col-span-1">
          ...
          <div className="flex flex-col items-center gap-4">
            <div className="w-28 h-28 rounded-full bg-slate-100 border border-slate-200 overflow-hidden">
              <img
                src={form.profilePic || `https://api.dicebear.com/7.x/notionists/svg?seed=${user?.name || 'user'}`}
                alt="Profile"
        ...
        <div className="bg-white border border-slate-200 rounded-3xl p-6 shadow-sm xl:col-span-2">
          <h3 className="text-lg font-display font-bold text-slate-800 mb-4">Personal Information</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <input name="age" type="number" value={form.age} onChange={onChange} placeholder="Age" className="rounded-xl border border-slate-300 px-4 py-2.5" />

            <select name="gender" value={form.gender} onChange={onChange} className="rounded-xl border border-slate-300 px-4 py-2.5 bg-white">
